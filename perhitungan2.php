            ...
            <div class="row">
              <div class="col-xl-4 col-lg-4 col-sm-4">
                <div class="card mt-4 ml-4 mb-2">
                  <div class="card-body">
                    <div class="box">
                      <div class="chartBig" data-percent="<?php echo $nilai_oee ?>" >56s%</div>
                      <h2>OEE</h2>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-xl-4 col-lg-4 col-sm-4">
                    <div class="card mt-4 mb-4" style="width: 100%">
                      <div class="card-body">
                        <div class="box">
                          <div class="chart" data-percent="<?php echo $nilai_availability ?>" >40%</div>
                            <h2>Availability</h2>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-sm-4">
                      <div class="card mt-4 mb-4" style="width: 100%">
                        <div class="card-body">
                          <div class="box">
                            <div class="chart" data-percent="<?php echo $nilai_performance?>" >60%</div>
                            <h2>Performance</h2>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-sm-4">
                      <div class="card mt-4 mr-4 mb-4" style="width: 100%">
                        <div class="card-body">
                          <div class="box">
                            <div class="chart" data-percent="<?php echo $nilai_quality ?>" >70%</div>
                            <h2>Quality</h2>
                          </div>
                        </div>
                      </div>
